    ...
    <div className="shell app-shell">
      ...
      <main className="main app-main">
        <div className="app-top-strip">
          ...
          <div className="app-top-actions"><button type="button" aria-label="الإشعارات"><Icon name="bell" size={20} /></button><span className="top-user-name">{user?.firstName} {user?.lastName}</span></div>
        </div>
        {children}
      </main>
    </div>
