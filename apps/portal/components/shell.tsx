      ...
      <div className="public-shell">
        ...
        <header className="public-header">
          <div className="public-header-inner">
            <Link className="public-brand" href="/" aria-label="طريق الشام - الرئيسية">
              ...
              <span><strong>طريق الشام</strong><small>رحلات أبعد… بأمان أكبر</small></span>
            </Link>
        ...
        <footer className="public-footer">
          <div className="public-footer-grid">
            ...
            <div><strong>الدعم</strong><span>خدمة ومتابعة على مدار الساعة</span><a href="tel:+963965350502">سوريا: +963 965 350 502</a><a href="tel:+96171967194">لبنان: +961 71 967 194</a><a href="https://alnokhbaeducation.com">alnokhbaeducation.com</a></div>
          </div>
