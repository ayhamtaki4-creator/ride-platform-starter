...
export default function AdminBookingsPage() {
  ...
  return (
    <ProtectedRoute roles={["SUPER_ADMIN", "ADMIN", "OPERATIONS_MANAGER"]}>
      <Shell>
        <DashboardHeader eyebrow="الإدارة" title="الحجوزات" subtitle="مراجعة الحجوزات وتعيين سائق وسيارة مؤهلين للمسار والتصاريح المطلوبة." />
        ...
        <section className="booking-list admin-booking-list">
          {bookings.map((booking) => {
            ...
            return <article className="booking-card" key={booking.id}>
              ...
              <div className="actions"><Link className="button" href={`/admin/bookings/${booking.id}`}>التفاصيل</Link></div>
            </article>;
          })}
        </section>
      </Shell>
